 ...
 * @RestResource(
 *   id = "nicol_incidents",
 *   label = @Translation("Nicol incidents"),
 *   serialization_class = "",
 *   uri_paths = {
 *     "canonical" = "/api/v1/incidents",
 *     "https://www.drupal.org/link-relations/create" = "/api/v1/incidents"
 *   }
 * )
 */
class NicolIncidents extends ResourceBase {
  ...
  public function post(array $data) {
    ...
    $result = $this->getIncidents($status, $message_types);
